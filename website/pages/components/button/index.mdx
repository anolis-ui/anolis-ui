...
import { Button, Tag, Spinner } from "anolis-ui";
...
<ComponentDisplay>
  {[
    [
      ...
      `
<Button
  loading // Toggle the spinner
  _spinner={{ color: "cyan" }} // Custom component props
  $spinner={Spinner} // Custom spinner component
  spinner="AAA" // Custom component children (unused by default)
/>`
    ],
  ]}
</ComponentDisplay>
